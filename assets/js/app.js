...
const HOME_ANNOUNCEMENTS = [
  ...
  {
    id: "announcement-compliance-trading-advisory-1",
    tag: "compliance",
    eyebrow: "Compliance Update",
    type: "Trading Advisory",
    format: "STAMP",
    title: "Trading Advisory 1",
    summary: "Dear Acuiteans, while seeking trading approval on STAMP, employees are required to enter the complete/correct name of the company they want to trade in. Pls. refrain from using stock symbols/incomplete company name while seeking approvals. If you have any queries in this regard, pls. reach out to Enaakshi Majumdar from Compliance Team at enaakshi.majumdar@acuite.in.",
    dateLabel: "Now live",
