...
def tighten_people_culture_yoga_winners_copy(apps, schema_editor):
    ...
    display["details"] = []
    display["closingNote"] = (
        "Thank you to everyone who participated and made the Yoga Session successful."
    )
...
class Migration(migrations.Migration):
    dependencies = [
        ("feed", "0023_refine_people_culture_yoga_winners_layout"),
    ]

    operations = [
        migrations.RunPython(
            tighten_people_culture_yoga_winners_copy,
