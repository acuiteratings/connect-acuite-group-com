...
DEFAULT_ATTENDANCE_OFFICE_NETWORKS = ",".join(
    [
        "122.179.133.53",
        "182.70.116.140",
        "14.142.18.26",
...
ATTENDANCE_OFFICE_NETWORKS = (
    os.getenv("ATTENDANCE_OFFICE_NETWORKS") or DEFAULT_ATTENDANCE_OFFICE_NETWORKS
).strip()
ATTENDANCE_ACTIVITY_WRITE_THROTTLE_SECONDS = int(
    os.getenv("ATTENDANCE_ACTIVITY_WRITE_THROTTLE_SECONDS", "300")
)
