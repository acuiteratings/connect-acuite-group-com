...
def store_coin_ledger_reaction_save(sender, instance, raw=False, **kwargs):
    if raw:
        return
...
def store_coin_ledger_reaction_delete(sender, instance, **kwargs):
    reverse_coin_ledger_for_reaction(instance)


@receiver(post_save, sender=Comment, dispatch_uid="store_coin_ledger_comment_save")
def store_coin_ledger_comment_save(sender, instance, raw=False, **kwargs):
    if raw:
        return
...
def store_coin_ledger_comment_delete(sender, instance, **kwargs):
    reverse_coin_ledger_for_comment(instance)


@receiver(post_save, sender=Post, dispatch_uid="store_coin_ledger_post_save")
def store_coin_ledger_post_save(sender, instance, raw=False, **kwargs):
    if raw:
        return
...
def store_coin_ledger_book_requisition_save(sender, instance, raw=False, **kwargs):
    if raw:
        return
...
def store_coin_ledger_redemption_save(sender, instance, raw=False, **kwargs):
    if raw:
        return
